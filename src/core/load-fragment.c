...
int config_parse_exec(
        ...
        do {
                ...
                r = extract_first_word_and_warn(&p, &firstword, WHITESPACE,
                                EXTRACT_QUOTES |
                                EXTRACT_CUNESCAPE |
                                EXTRACT_CONTAINS_VARIABLES |
                                EXTRACT_CONTAINS_SPECIFIERS,
                ...
                while (!isempty(p)) {
                        ...
                        r = extract_first_word_and_warn(&p, &word, WHITESPACE,
                                        EXTRACT_QUOTES |
                                        EXTRACT_CUNESCAPE |
                                        EXTRACT_CONTAINS_VARIABLES |
                                        EXTRACT_CONTAINS_SPECIFIERS,
